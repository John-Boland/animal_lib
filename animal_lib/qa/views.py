...
from animal_lib.helpers import ajax_required
from animal_lib.qa.models import Question, Answer
from animal_lib.qa.forms import QuestionForm


class QuestionIndexListView(LoginRequiredMixin, ListView):
...
class QuestionAnsListView(QuestionIndexListView):
...
class QuestionDetailView(LoginRequiredMixin, DetailView):
    """View to call a given Question object and to render all the
    details about that Question."""
    model = Question
